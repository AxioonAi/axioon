...
export function ChartTip({ content }: Props) {
  ...
  return (
    <div className="chartTipContainer absolute top-4 right-8 md:right-4 transition duration-200 ease-in cursor-pointer">
      <Image
        width={36}
        height={36}
      ...
      <div
        ...
        } ${showTip ? "block" : "invisible"} transition duration-300 ease-in`}
      >
        {content}
